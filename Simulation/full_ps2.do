...
add wave -divider "Keyboard Outputs"        key_clock \
                                            data
add wave -divider "Other Inputs"            clk \
                                            reset
add wave -divider "Error Checking"          sim:/Final_Project/ps2keyboard/parity_error1 \
                                            sim:/Final_Project/ps2keyboard/parity_error2
add wave -binary -divider "Raw Data"        sim:/Final_Project/ps2keyboard/key1 \
                                            sim:/Final_Project/ps2keyboard/key2
add wave -hexadecimal -divider "Scan Codes" code1 \
                                            code2
add wave -divider "Internal"                sim:/Final_Project/ps2keyboard/shift \
                                            sim:/Final_Project/ps2keyboard/counter \
                                            sim:/Final_Project/ps2keyboard/state \
                                            sim:/Final_Project/ps2keyboard/nextstate
